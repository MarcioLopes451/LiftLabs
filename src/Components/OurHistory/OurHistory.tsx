  ...
  return (
    <section className="mt-10">
      <div className="flex justify-center items-center flex-col">
        <div className="bg-[#1B2126] w-[310px] flex justify-center items-center flex-col gap-3 text-center px-[17.5px] py-[45px]">
        ...
        <img src={Gallery2} className="h-[365px]" />
        <img src={Gallery3} className="h-[365px]" />
        <div className="bg-[#1B2126] w-[310px] flex justify-center items-center flex-col gap-3 text-center px-[17.5px] py-[45px]">
